...
export interface IStorage {
  ...
  atualizarUnidadeCurricular(id: number, data: Partial<InsertUnidadeCurricular>): Promise<UnidadeCurricular>;
  excluirUnidadeCurricular(id: number): Promise<void>;
  ...
  atualizarAvaliacao(id: number, data: Partial<InsertAvaliacao>): Promise<Avaliacao>;
...
export class DatabaseStorage implements IStorage {
  ...
  async atualizarUnidadeCurricular(id: number, data: Partial<InsertUnidadeCurricular>): Promise<UnidadeCurricular> {
    const [uc] = await db.update(unidadesCurriculares).set(data).where(eq(unidadesCurriculares.id, id)).returning();
    return uc;
  }

  async excluirUnidadeCurricular(id: number): Promise<void> {
    await db.delete(criteriosAvaliacao).where(eq(criteriosAvaliacao.unidadeCurricularId, id));
    await db.delete(avaliacoes).where(eq(avaliacoes.unidadeCurricularId, id));
    await db.delete(unidadesCurriculares).where(eq(unidadesCurriculares.id, id));
  }
  ...
  async atualizarAvaliacao(id: number, data: Partial<InsertAvaliacao>): Promise<Avaliacao> {
    const [a] = await db.update(avaliacoes).set(data).where(eq(avaliacoes.id, id)).returning();
    return a;
  }
